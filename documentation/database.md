...
Planned entities: file reports with S3 object keys, notifications/delivery attempts, audit events, configurable hospital settings, and revocable sessions. These are not represented as fake active tables.
